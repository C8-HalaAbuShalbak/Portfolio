...
function App() {
  ...
  return (
    <>
   <div className="grid-cols-1 App"  style={{minHeight: "100vh" ,minWidth: "100vw"}}  onMouseMove={
changePosition
   }
    ...
    <div className="inner-cursor-style " ref={innerCursor}> </div>
      ...
      <aside className="w-3 h-[90vh] bg-purple-100 ml-[25vw] mt-[2rem] rounded relative ">
        ...
        <ul
          ...
          id="projects" onClick={hadleShowProjects}
        >
          My Projects{" "}
         {showProjects&&(
         <ul className=" flex gap-2 flex-col list-none text-xl text-yellow-200 ">
          <li className="hover:tracking-widest" ><a href="#p1">Test Your Memory</a></li>
          <li className="hover:tracking-widest"><a href="#p2">My Task Manager</a></li>
          <li className="hover:tracking-widest"> <a href="#p3" >Easy Knowledge</a></li>
          <li className="hover:tracking-widest"> <a href="#p4">Cure App</a></li>
         </ul>
      ...
      <div id ="p1"className=" ml-[25vw] grid-col-4 justify-center border-solid border-white w-full h-full ">
