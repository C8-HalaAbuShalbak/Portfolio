  ...
  return (
    <>
      ...
      <div className="cursor-style delay-[500] " ref={cursor}>
        ...
        <aside className="w-3 min-h-screen bg-purple-100 m-2 md:ml-[25vw]  rounded relative ">
                  ...
                  <div className="absolute felx flex-col gap-2 p-4 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8 w-full h-96">
                    <p className=" col-start-1 col-end-2">
                      ...
                      <p className=" text-sm sm:text-sm">
                        ...
                        home medical specialized services besides general
                        personal services.
                      </p>
                    </p>
        ...
        {showContact && (
          <div
            id="contactMe"
            className="flex min-h-80  rounded-lg m-auto  items-center w-[80vw] justify-self-center justify-center bg-none text-white shadow-lg shadow-white cursor-none"
          >
